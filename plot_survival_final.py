...
# --- Plotting ---
fig, ax = plt.subplots(figsize=(4.5, 3)) # Slightly wider for legend
...
ax.step(x_ticks, crl_mean, where='post', label='Control', color=colors['Control'], linewidth=1.5, zorder=5)
...
# --- Hardcore Annotation (P-value) ---
# Placing the text in the lower-left area which is empty due to IP_high drop
ax.text(0.05, 0.05, 'IP_high vs. Control\nLog-rank test, $P = 0.0006$', 
...
plt.tight_layout()
save_pub_py(fig, 'survival_curve_final')
print("Final figure saved as survival_curve_final.png/pdf/svg")
